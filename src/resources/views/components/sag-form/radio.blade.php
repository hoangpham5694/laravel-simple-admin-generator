@props(['name', 'label' => null, 'id' => null, 'value' => 1, 'checked' => false, 'inline' => false, 'help' => null])
...
<div class="form-group">
    <div @class(['form-check', 'form-check-inline' => $inline])>
        <input type="radio" name="{{ $name }}" id="{{ $fieldId }}" value="{{ $value }}" @checked($isChecked) {{ $attributes->class(['form-check-input', 'is-invalid' => $hasError]) }}>
        @if ($label !== null)
